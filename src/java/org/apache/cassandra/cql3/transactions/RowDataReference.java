...
public class RowDataReference extends Term.NonTerminal
{
    ...
    private CellPath bindCellPath(FunctionContext context)
    {
        if (fieldPath != null)
            return fieldPath;

        return elementPath != null ? CellPath.create(elementPath.bindAndGet(context)) : null;
    }

    public TxnReference toTxnReference(FunctionContext context)
    {
